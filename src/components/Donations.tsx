      ...
      <aside className="w-64 ml-7 " aria-label="Sidebar">
        <div className="overflow-y-auto py-4 px-3  bg-secondary  rounded-xl dark:bg-secondary">
          <ul className="space-y-2">
            <li>
              <Link href="vips">
                <div className="flex items-center p-2 text-base cursor-pointer font-normal text-gray-100 rounded-lg dark:text-white hover:bg-gray-800 dark:hover:bg-gray-700">
                  <FontAwesomeIcon
            ...
            <li>
              {wallets.length > 0 &&
                wallets.map((wallet, id) => (
                  <div
                    key={id}
                    className="flex items-center cursor-pointer p-2 text-sm ml-4 font-normal text-gray-100 rounded-lg dark:text-white hover:bg-gray-800 dark:hover:bg-gray-700"
                  >
                    {wallet}
                  </div>
                ))}
